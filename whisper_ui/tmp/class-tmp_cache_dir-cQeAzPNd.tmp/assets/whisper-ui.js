  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child1 = (function() {
      return {
        ...
        statements: [
          ["element","action",["authenticateSession"],[],["loc",[null,[11,24],[11,58]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    return {
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        ...
        morphs[0] = dom.createMorphAt(dom.childAt(fragment, [0, 1, 5]),3,3);
        morphs[1] = dom.createAttrMorph(element2, 'id');
        morphs[2] = dom.createMorphAt(element2,1,1);
        return morphs;
      },
      statements: [
        ["block","if",[["get","session.isAuthenticated",["loc",[null,[8,12],[8,35]]]]],[],0,1,["loc",[null,[8,6],[12,13]]]],
